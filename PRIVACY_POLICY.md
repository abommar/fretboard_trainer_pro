...
The app has **no internet connection** — it makes zero network requests. There are no servers, no accounts, no cloud sync, and no third-party SDKs.
...
- Microphone access is only active while the Chromatic Tuner screen is open and the tuner is running.
- You can deny microphone permission at any time in your device settings. All other features of the app will continue to work normally without microphone access.
...
The app saves the following data **locally on your device only**, using iOS UserDefaults (iOS) and SharedPreferences (Android):

| Setting | Purpose |
|---|---|
| Sound enabled | Remember your sound on/off preference |
| Use flats notation | Remember your ♭/♯ preference |
| Haptics enabled | Remember your haptics preference |
| Fretboard style | Remember your chosen wood theme |
| Best streak per game mode | Track your personal best streaks |
| Best timed scores per mode | Track your personal best timed scores |

This data never leaves your device. It is not backed up to any cloud service controlled by us, though it may be included in standard device backups (iCloud on iOS, Google Backup on Android) per your own device settings.
...
The app is built entirely on platform-native APIs (Apple frameworks on iOS; Android SDK on Android).
...
If we update this privacy policy, we will post the revised version here with an updated effective date. Material changes will be noted in the app's release notes.
